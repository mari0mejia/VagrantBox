...
#line 44 "rpn.y"
                                     { rpnstack.push(yyvsp[0]);/*push yylval onto stack*/ }
#line 1092 "rpn.tab.c"
    break;

  case 5: /* misc_non_term_symbol: T_MULTIPLY  */
#line 45 "rpn.y"
                 { if(stack_error(2)) break; int a=rpnstack.top(); rpnstack.pop(); int b=rpnstack.top(); rpnstack.pop(); rpnstack.push(a*b);}
#line 1098 "rpn.tab.c"
    break;

  case 6: /* misc_non_term_symbol: T_DIVIDE  */
#line 46 "rpn.y"
               { if(stack_error(2)) break; int a=rpnstack.top(); rpnstack.pop(); int b=rpnstack.top(); rpnstack.pop(); rpnstack.push(a/b);}
#line 1104 "rpn.tab.c"
    break;

  case 7: /* misc_non_term_symbol: T_PLUS  */
#line 47 "rpn.y"
             { if(stack_error(2)) break; int a=rpnstack.top(); rpnstack.pop(); int b=rpnstack.top(); rpnstack.pop(); rpnstack.push(a+b);}
#line 1110 "rpn.tab.c"
    break;

  case 8: /* misc_non_term_symbol: T_MINUS  */
#line 48 "rpn.y"
              { if(stack_error(2)) break; int a=rpnstack.top(); rpnstack.pop(); int b=rpnstack.top(); rpnstack.pop(); rpnstack.push(a-b);}
#line 1116 "rpn.tab.c"
    break;
