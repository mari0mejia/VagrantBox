...
//Map of C++ type to GPL::Type
/* static */  std::unordered_map<std::type_index, GPL::Type> Prop::typemap {
    {std::type_index(typeid(int)),                   GPL::INT},
    {std::type_index(typeid(std::string)),           GPL::STRING},
    {std::type_index(typeid(double)),                GPL::DOUBLE},
    {std::type_index(typeid(Animation_code*)),       GPL::ANIMATION_BLOCK},
    {std::type_index(typeid(const Animation_code*)), GPL::ANIMATION_BLOCK},
};
